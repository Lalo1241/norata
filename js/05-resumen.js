...
function renderSummary() {
  ...
  const W = {
    /* ---- La tarjeta de la racha ----
       Desde la 0.7.135 cuenta SEMANAS encendidas y vive en js/05c-racha.js,
       con su historia. Aquí solo se pide el cuerpo; el dibujo se pinta al
       final de `renderSummary`, porque se hace al tamaño real del hueco. */
    racha: () => cuerpoRacha(),
