...
const TEXTOS_EN = {
  ...
  /* La racha: semanas encendidas y «Tu racha» (0.7.135, js/05c-racha.js).
     Las palabras de cada mundo entran en frases con hueco —«Semana {0}»,
     «Te quedan {0} días esta semana para {1}»—, así que se traducen para
     encajar ahí: «encenderla» es «light it», no «to light it». */
  "semana encendida": "week lit",
  "semanas encendidas": "weeks lit",
  "encendida": "lit",
  "encendidas": "lit",
  "la fogata": "the campfire",
  "encenderla": "light it",
  "semana trazada": "week drafted",
  "semanas trazadas": "weeks drafted",
  "trazada": "drafted",
  "trazadas": "drafted",
  "el plano": "the blueprint",
  "trazarla": "draft it",
  "semana en vitrina": "week on display",
  "semanas en vitrina": "weeks on display",
  "en vitrina": "on display",
  "la vitrina": "the display case",
  "ponerla en la vitrina": "put it on display",
  "semana superada": "week cleared",
  "semanas superadas": "weeks cleared",
  "superada": "cleared",
  "superadas": "cleared",
  "superarla": "clear it",
  ...
  "Tus {0} semanas se quedan. El domingo empieza otra.": "Your {0} weeks stay. A new one starts Sunday.",
  "La de la semana pasada se queda. El domingo empieza otra.": "Last week's stays. A new one starts Sunday.",
  "El domingo empieza otra, desde cero y sin deudas.": "A new one starts Sunday, from zero and owing nothing.",
  "Hoy es el último día": "Today is the last day",
  "Justo a tiempo": "Just in time",
  "Un registro hoy y queda {0}.": "One entry today and it's {0}.",
  "Quedan {0} días y hacen falta los {1}, empezando hoy.": "{0} days left and you need all {1}, starting today.",
  "Falta 1 día": "1 day to go",
  "Faltan {0} días": "{0} days to go",
  "Te quedan {0} días esta semana para {1}.": "You have {0} days left this week to {1}.",
  "TRAZADA": "DRAFTED",
  "Semanas de antes": "Earlier weeks",
  "{0} {1}. {2}. Toca para ver tu calendario": "{0} {1}. {2}. Tap to see your calendar",
  "Toca la tarjeta para ver tu calendario": "Tap the card to see your calendar",
  "{0} de {1} días": "{0} of {1} days",
  "Este año": "This year",
  "Mes anterior": "Previous month",
  "Mes siguiente": "Next month",
  "día con algo": "day with something",
  "días con algo": "days with something",
  "Ir a mis misiones": "Go to my missions",
  "Tu racha": "Your streak",
  "tu mejor racha": "your best streak",
  "semana en el año": "week this year",
  "semanas en el año": "weeks this year",
  "días esta semana": "days this week",
  "Semana {0}: {1} días con algo o más": "Week {0}: {1} or more days with something",
  ...
  "Plegar todas": "Collapse all",
  "Desplegar todas": "Expand all",
  "Todas plegadas": "All collapsed",
  "Todas desplegadas": "All expanded",
  "{0} en curso": "{0} in progress",
  "{0} por abrir": "{0} ready to start",
  "{0} por desbloquear": "{0} still locked",
  "todo conseguido": "all done",
  "sin talentos todavía": "no talents yet",
  "Sigue:": "Next:",
  ...
  "Aplicar": "Apply",
  "Asegurados": "Secured",
  /* «Theme» y no «Look»: este es el interruptor de claro y oscuro. «Look» se
  ...
  */
  ...
  "Todos": "All",
  /* Los mundos y los recolores: la reja de «Mi apariencia». Los nombres se
    traducen —un mundo te RENOMBRA lo que llevas recorrido, y dejarlo a
    medias es lo peor de las dos lenguas— salvo los que ya son iguales en
    las dos (Adobe, Blueprint) y los nombres propios de un sitio. */
 "Musgo": "Moss",
 "Arboleda": "Grove",
 "Consola": "Console",
 "Nuevo": "New",
 ...
 "Nuevo tablero": "New board",
 "Nueva rama": "New branch",
 "Tus ramas de proyectos": "Your project branches",
 "Añadir misión a {0}": "Add a mission to {0}",
 "Añadir encargo a {0}": "Add a task to {0}",
 "Añadir una etapa a {0}": "Add a stage to {0}",
 "Añadir talento a {0}": "Add a skill path to {0}",
 "Nivel de zoom, en porcentaje": "Zoom level, as a percentage",
 "Ajustar todo a la pantalla": "Fit everything on screen",
 "clic derecho: crear, editar y pantalla completa": "right click: create, edit and full screen",
 "clic derecho: crear y más acciones": "right click: create and more",
 "Estancado {0} días": "Stalled for {0} days",
 "Estancado {0} días — retómalo o suéltalo": "Stalled for {0} days — pick it back up or let it go",
 "{0} días sin avance · {1}% hecho": "{0} days without progress · {1}% done",
 "{0}% hecho, lo más avanzado": "{0}% done, the furthest along",
 "Vence en 1 día": "Due in 1 day",
 "Vence en {0} días": "Due in {0} days",
 "Días de los últimos {0} en que apareció cada una.": "Days out of the last {0} each one showed up.",
 "Esto es con lo que nacen las habilidades nuevas.": "This is what new skills start with.",
 "Una de las tuyas va con otros números, porque la creaste antes o la ajustaste a mano.": "One of yours runs on different numbers, because you created it earlier or tuned it by hand.",
 ...
 "Rango {0}": "{0} rank",
 "Conseguido": "Earned",
 "Ambiente nuevo": "New ambience",
 "Alcanzaste el nivel {0} de tu expedición": "You reached level {0} of your expedition",
 "Rango {0} conseguido": "{0} rank earned",
 "Empiezas a trazar {0}": "You start charting {0}",
 "Aviso de privacidad": "Privacy notice",
 "Términos y condiciones": "Terms and conditions",
 "Vista previa de la apariencia": "Preview of the look",
 "Ahí son las {0}. Tu día en la app: {1}.": "It's {0} there. Your day in the app: {1}.",
 "Escritura": "Writing",
 /* El escaparate de pantallas del panel de administración. */
  ...
  */
  ...
  "cuarto": "fourth",
  "quinto": "fifth",
  "Un año de expedición": "One year of expedition",
  "{0} años de expedición": "{0} years of expedition",
  "días desde que empezaste": "days since you started",
  "Fue el {0}. Esto es lo que pasó desde entonces.": "It was {0}. Here's what happened since.",
  "Todo empezó aquí": "It all started here",
  ...
  "De 2 a 4 de la madrugada": "2 to 4 in the morning",
  "De 4 a 6 de la mañana": "4 to 6 AM",
  "De 6 a 8 de la mañana": "6 to 8 AM",
  "De 8 a 10 de la mañana": "8 to 10 AM",
  "De 10 de la mañana a mediodía": "10 AM to noon",
  "De mediodía a las 2": "Noon to 2 PM",
  "De 2 a 4 de la tarde": "2 to 4 PM",
  "De 4 a 6 de la tarde": "4 to 6 PM",
  "De 6 a 8 de la tarde": "6 to 8 PM",
  "De 8 a 10 de la noche": "8 to 10 PM",
  "De 10 de la noche a medianoche": "10 PM to midnight",
  "El día ya había terminado oficialmente. Tú todavía no.": "The day was officially over. You weren't.",
  "Mientras el mundo entero dormía, tú ya ibas avanzando en lo tuyo.": "While the whole world slept, you were already moving your own things forward.",
  "Antes que el sol, antes que la alarma, antes que nadie: tú.": "Before the sun, before the alarm, before anyone: you.",
  "El día apenas estiraba los brazos y tú ya le llevabas ventaja.": "The day was still stretching and you were already ahead of it.",
  "El café todavía estaba caliente y tú ya ibas por la segunda misión.": "The coffee was still hot and you were already on your second mission.",
  "Cuando la mañana agarra ritmo, tú ya ibas con todo.": "By the time the morning picked up pace, you were already in full swing.",
  "Entre la comida y tus actividades diarias, siempre encontraste un hueco para lo tuyo.": "Between lunch and everything else in your day, you always found room for your own things.",
  "En plena tarde, con mil cosas encima, tú seguías cumpliendo.": "Mid-afternoon, with a thousand things going on, you kept delivering.",
  "Al cerrar tu jornada, todavía te hacías un tiempo para ti. Eso se llama saber organizarse.": "As your workday wrapped up, you still made time for yourself. That's what being organized looks like.",
  "Mientras el día de todos terminaba, el tuyo seguía sumando.": "While everyone else's day was ending, yours kept adding up.",
  ...
  "Nivel": "Level",
  "Del nivel {0} al {1}. Hoy «{2}» ya es parte de quien eres.": "From level {0} to {1}. Today «{2}» is part of who you are.",
  "Días encendidos": "Days lit up",
  "Cada estrella es un día en que hiciste algo. Juntas dibujan algo que antes no estaba.": "Each star is a day you did something. Together they draw something that wasn't there before.",
  "Lo que construiste": "What you built",
  "talento terminado": "talent completed",
  "talentos terminados": "talents completed",
  "etapa cerrada en tus proyectos": "project stage closed",
  "etapas cerradas en tus proyectos": "project stages closed",
  "Cosas que hace un año solo eran ideas. Ahora son realidad.": "Things that were only ideas a year ago. Now they're real.",
  "Quién eras, quién eres": "Who you were, who you are",
  "hace un año": "a year ago",
  "Este año cerraste una constelación y ya dibujas la de {0}.": "This year you closed a constellation and you're already drawing {0}'s.",
  "Este año cerraste {0} constelaciones y ya dibujas la de {1}.": "This year you closed {0} constellations and you're already drawing {1}'s.",
  "Tu constelación de {0} ya brilla con {1} de sus {2} estrellas. Las que faltan se encienden con cada nivel que subas.": "Your {0} constellation already shines with {1} of its {2} stars. The rest light up with every level you climb.",
  "{0} juntos. Lo mejor de este viaje todavía está por escribirse.": "{0} together. The best part of this journey is still to be written.",
  "{0} juntos. Vamos por más.": "{0} together. Here's to more.",
  "Gracias por darnos un lugar en tu año. Aquí seguimos, con el mapa abierto y muchas ganas de ver lo que viene.": "Thanks for giving us a place in your year. We're still here, map open, excited to see what comes next.",
  "Gracias por dejarnos acompañarte este año. Verte avanzar, día a día, es la mejor parte de hacer Norata.": "Thanks for letting us walk with you this year. Watching you move forward, day by day, is the best part of making Norata.",
  "Gracias por dejarnos acompañarte estos {0} años. Verte avanzar, día a día, es la mejor parte de hacer Norata.": "Thanks for letting us walk with you these {0} years. Watching you move forward, day by day, is the best part of making Norata.",
  "Seguir mi expedición": "Continue my expedition",
  "Lo puedes volver a ver en Mi expedición.": "You can watch it again in My expedition.",
  "Aniversario de expedición": "Expedition anniversary",
  "Anterior": "Previous",
  "Seis meses de expedición": "Six months of expedition",
  "Medio año de expedición. Lo mejor del viaje todavía no se escribe.": "Half a year of expedition. The best of the journey is yet to be written.",
  "Medio año desde tu primera misión, «{0}». Lo mejor del viaje todavía no se escribe.": "Half a year since your first mission, «{0}». The best of the journey is yet to be written.",
  "Medio año desde tu primera misión, «{0}». Hoy llevas {1} cumplidas.": "Half a year since your first mission, «{0}». You've completed {1} so far.",
  "Tu {0} año": "Your {0} year",
  ...
  */
  ...
  /* ================= Los caminos: el contenido =================
     Los diez caminos que se sueltan en el tablero. El JSON se queda en espanol y
     se traduce al DIBUJAR, como todas las tablas — pero aqui hay un motivo mas:
     caminos/caminos.json lo GENERA caminos/app.py desde plantillas/LEEME.md, asi
     que un JSON traducido a mano lo borraria el generador la proxima vez.
     Y un sitio mas que en las otras tablas: los caminos no solo se pintan, se
     COPIAN al tablero. Lo que se guarda -el nombre del peldano, sus pasos, la
     rama, las misiones- es el rotulo que esa cosa va a llevar para siempre.
  */

  "Correr 10K sin parar": "Run 10K without stopping",
  "9 semanas hasta 5K, 16 hasta 10K": "9 weeks to 5K, 16 to 10K",
  "plan de intervalos progresivos": "progressive interval plan",
  "Tres caminatas de 30 minutos": "Three 30-minute walks",
  "Elegir tres días fijos de la semana": "Pick three fixed days of the week",
  "Salir la primera vez": "Go out the first time",
  "Repetirla dos veces más": "Do it twice more",
  "Que las tres sean de 30 minutos": "Make all three 30 minutes long",
  "Calzado para correr": "Running shoes",
  "Semana 1: correr 1 minuto y caminar 90 segundos, ocho veces":
    "Week 1: run 1 minute, walk 90 seconds, eight times",
  "Cinco minutos de caminata rápida antes": "Five minutes of brisk walking first",
  "Un minuto corriendo, 90 caminando": "One minute running, 90 seconds walking",
  "Repetirlo ocho veces": "Repeat it eight times",
  "Hacerlo tres días de la semana": "Do it three days a week",
  "Semana 2: correr 90 segundos y caminar 2 minutos, seis veces":
    "Week 2: run 90 seconds, walk 2 minutes, six times",
  "Semana 3: dos rondas de 90 segundos y de 3 minutos":
    "Week 3: two rounds of 90 seconds and of 3 minutes",
  "Semana 4: 3 y 5 minutos, dos veces cada uno": "Week 4: 3 and 5 minutes, twice each",
  "Semana 5: tus primeros 20 minutos sin parar":
    "Week 5: your first 20 minutes without stopping",
  "Los dos primeros días de la semana siguen con intervalos":
    "The week's first two days stay on intervals",
  "El tercero son 20 minutos seguidos": "The third is 20 minutes straight",
  "Ir al ritmo que te deje hablar": "Go at a pace that still lets you talk",
  "Tres salidas por semana, cuatro semanas seguidas": "Three runs a week, four weeks in a row",
  "Semana 6: 25 minutos sin parar": "Week 6: 25 minutes without stopping",
  "Semanas 7 y 8: 25 y 28 minutos, tres veces cada una":
    "Weeks 7 and 8: 25 and 28 minutes, three times each",
  "Semana 9: 30 minutos seguidos, que son tus 5K":
  ...
  "Salir a correr": "Go for a run",
  "Estirar 10 minutos": "Stretch for 10 minutes",
  "Un idioma hasta poder conversar": "A language until you can hold a conversation",
  "12 a 18 meses": "12 to 18 months",
  "por horas acumuladas": "by hours accumulated",
  "Presentarte y pedir algo sin pensarlo":
    "Introduce yourself and order something without thinking",
  "Decir tu nombre y de dónde eres": "Say your name and where you're from",
  "Pedir algo en un lugar": "Order something somewhere",
  "Preguntar por un precio": "Ask how much something costs",
  "Decir que no entendiste": "Say you didn't understand",
  "El método que vas a terminar": "The method you're going to finish",
  "Las primeras 70 horas: te defiendes en lo básico":
    "The first 70 hours: you get by on the basics",
  "Llevar la cuenta de las horas, no de los días": "Count the hours, not the days",
  ...
  "Lo que fallas vuelve al montón de hoy": "What you get wrong goes back to today's pile",
  "Mil palabras que recuerdas antes de mirarlas":
    "A thousand words you recall before looking them up",
  "Apuntar las que te salgan al paso": "Write down the ones you come across",
  "*Intentar recordarlas antes de mirar la respuesta*, siempre":
    "*Try to recall them before looking at the answer*, always",
  "Lo que recuerdas sin ayuda, sale del montón": "What you recall unaided leaves the pile",
  "Tu primera conversación de cinco minutos": "Your first five-minute conversation",
  "Las 180 horas: te mueves solo en una conversación sencilla":
    "180 hours: you hold your own in a simple conversation",
  "Entender un video corto sin subtítulos": "Understand a short video without subtitles",
  "Leer un libro entero en ese idioma": "Read a whole book in that language",
  "Media hora de conversación sin cambiar de idioma":
    "Half an hour of conversation without switching languages",
  ...
  "Aprobar el examen oficial que elijas": "Pass the official exam you choose",
  ...
  "Música": "Music",
  "12 meses": "12 months",
  "acordes abiertos y cambios cronometrados": "open chords and timed changes",
  "El instrumento y lo que hace falta": "The instrument and what it needs",
  "Afinarlo tú, sin la aplicación": "Tune it yourself, without the app",
  "G, C y D: tres acordes que suenan limpios": "G, C and D: three chords that ring clean",
  "Aprender la forma de cada uno": "Learn each shape",
  "Que suenen las seis cuerdas": "Get all six strings to sound",
  "Sin mirar la mano": "Without looking at your hand",
  "Quince minutos, cinco días por semana, un mes":
    "Fifteen minutes, five days a week, one month",
  "Diez cambios limpios en un minuto": "Ten clean changes in a minute",
  "Elegir dos acordes": "Pick two chords",
  "Poner sesenta segundos": "Set sixty seconds",
  "Contar solo los cambios limpios": "Count only the clean changes",
  "Apuntar el número": "Write down the number",
  "Sesenta cambios limpios en un minuto": "Sixty clean changes in a minute",
  "Un cambio por segundo es la meta": "One change a second is the goal",
  "Subir de uno en uno": "Go up one at a time",
  "Cambiar la pareja de acordes cuando llegues": "Change the pair of chords once you get there",
  "Una canción entera de tres acordes": "A whole three-chord song",
  "Tocar a tiempo con el metrónomo, sin frenar":
    "Play in time with the metronome, without slowing",
  "La cejilla del F, sin que zumbe ninguna cuerda": "The F barre, with no string buzzing",
  "El dedo índice plano sobre el traste": "Index finger flat across the fret",
  "Presionar con el brazo, no con la fuerza del dedo":
    "Press with your arm, not with finger strength",
  "Cuerda por cuerda hasta que ninguna zumbe": "String by string until none buzz",
  "Cinco canciones que te salgan de memoria": "Five songs you can play from memory",
  "Tocarle a alguien, en vivo": "Play for someone, live",
  "Una canción con cejilla, entera": "A whole song with a barre chord",
  "Acompañarte cantando al mismo tiempo": "Sing along while you play",
  "Cantar la letra sin tocar": "Sing the words without playing",
  ...
  "Todas tus deudas en una sola hoja": "Every debt on a single sheet",
  "Juntar todos los estados de cuenta": "Gather every statement",
  "Apuntar cuánto debes en cada una": "Write down what you owe on each",
  "Apuntar cuánto cobra cada una": "Write down what each one charges",
  "Sumar el total": "Add up the total",
  "Saber cuánto te queda libre cada mes": "Know how much is left over each month",
  "Elegir el orden: bola de nieve o avalancha": "Pick the order: snowball or avalanche",
  "De la más chica a la más grande, o de la que más interés cobra":
    "Smallest to largest, or highest interest first",
  "Escribir el orden y no cambiarlo a media carrera":
    "Write the order down and don't change it midway",
  "Pagar el mínimo en todas, sin fallar un mes":
    "Pay the minimum on all of them, without missing a month",
  "Poner los mínimos en automático": "Put the minimums on autopay",
  "Que ninguna se te pase de fecha": "Don't let any of them go past their date",
  "Todo lo que sobre va a la primera de la lista":
    "Everything left over goes to the first on the list",
  "Un mes anotando cada gasto": "A month writing down every expense",
  "Cerrar la primera deuda": "Close the first debt",
  "Rodar ese pago entero a la siguiente": "Roll that whole payment onto the next one",
  "Sumar lo que pagabas a la que cerraste al mínimo de la siguiente":
    "Add what you were paying on the closed one to the next one's minimum",
  "Ese es tu pago nuevo": "That's your new payment",
  "No bajarlo aunque te sobre el dinero": "Don't lower it even if you have money to spare",
  "Tres meses sin deuda nueva": "Three months with no new debt",
  "Renegociar la que más intereses cobra": "Renegotiate the one charging the most interest",
  "Cerrar la segunda": "Close the second",
  "Bajar el total a la mitad": "Cut the total in half",
  "Cerrar la última": "Close the last one",
  "El último pago": "The final payment",
  "Pedir la carta de que no debes nada": "Ask for the letter saying you owe nothing",
  "Guardarla": "Keep it",
  "Un mes de gastos guardado": "One month of expenses saved",
  "Anotar los gastos del día": "Write down today's spending",
  "Revisar cómo va la bola": "Check how the snowball is going",

  /* ---- Los caminos, segunda mitad ----
  */

  "Programar y llegar al primer trabajo": "Learn to code and land your first job",
  "Carrera": "Career",
  "un lenguaje, y postular desde el primer proyecto":
    "one language, and apply from the first project",
  "Elegir un lenguaje y no cambiarlo en seis meses":
    "Pick one language and don't switch for six months",
  "El curso que vas a terminar": "The course you're going to finish",
  "Tu primer programa que hace algo útil": "Your first program that does something useful",
  "Instalar lo que hace falta": "Install what you need",
  "Que corra y salga algo en pantalla": "Get it running with something on screen",
  "Cambiarlo y que siga corriendo": "Change it and keep it running",
  "Enseñárselo a alguien": "Show it to someone",
  "Una hora al día, cinco días, dos meses": "One hour a day, five days a week, two months",
  "Escribir una función tuya sin copiarla": "Write a function of your own without copying it",
  "Tu primer proyecto publicado en internet": "Your first project published online",
  "Elegir algo pequeño que resuelva un problema tuyo":
    "Pick something small that solves a problem of yours",
  "Terminarlo aunque quede feo": "Finish it even if it comes out ugly",
  "Subirlo": "Put it online",
  "Que otra persona pueda abrirlo": "Make sure someone else can open it",
  "Usar control de versiones todos los días": "Use version control every day",
  "Tres proyectos propios, no del curso": "Three projects of your own, not from the course",
  "Diez postulaciones enviadas": "Ten applications sent",
  "Currículum de una página": "A one-page CV",
  "Elegir diez lugares": "Pick ten places",
  "Mandar las diez": "Send all ten",
  "Anotar cuáles contestan": "Write down which ones reply",
  "Tu portafolio en línea, con tu nombre": "Your portfolio online, under your name",
  "La primera entrevista técnica": "The first technical interview",
  "Repasar lo básico que siempre preguntan": "Review the basics they always ask",
  "Una entrevista de práctica con alguien": "A practice interview with someone",
  "La de verdad": "The real one",
  "Apuntar qué no supiste": "Write down what you didn't know",
  "Cincuenta postulaciones y un registro de cuáles contestan":
    "Fifty applications and a record of which reply",
  "Diez por semana": "Ten a week",
  "Anotar fecha, lugar y respuesta": "Note the date, the place and the reply",
  "Mirar el registro cada mes y cambiar lo que no funciona":
    "Look at the record each month and change what isn't working",
  "El primer trabajo": "The first job",
  "Programar una hora": "Code for an hour",
  "Mandar postulaciones": "Send applications",
  "6 meses": "6 months",
  "simulacros con reloj": "mocks against the clock",
  "la de tu campo": "the one from your field",
  "Elegir cuál y apuntar la fecha del examen": "Pick which one and write down the exam date",
  "Contar hacia atrás las semanas que te quedan": "Count backwards the weeks you have left",
  "Apuntar la fecha": "Write down the date",
  "Contar las semanas": "Count the weeks",
  "Repartir el temario entre ellas": "Spread the syllabus across them",
  "Dejar las dos últimas para repasar": "Leave the last two for review",
  "La inscripción al examen": "The exam registration",
  "Leer el temario oficial completo, una vez": "Read the whole official syllabus, once",
  "Bajar el temario oficial y no un resumen de internet":
    "Download the official syllabus, not a summary off the internet",
  "Leerlo entero sin estudiar": "Read it end to end without studying",
  "Marcar lo que no entiendes": "Mark what you don't understand",
  "El primer simulacro, salga como salga": "The first mock, however it goes",
  "Buscar un simulacro completo": "Find a full mock",
  "Hacerlo con reloj y sin consultar nada":
    "Take it against the clock and without looking anything up",
  "Anotar el resultado sin juzgarlo": "Write down the score without judging it",
  "Saber tu porcentaje de partida": "Know your starting percentage",
  "Una hora al día, tres meses": "One hour a day, three months",
  "Repasar solo lo que fallas, un mes": "Review only what you get wrong, for a month",
  "Sacar la lista de lo que fallaste": "Pull the list of what you got wrong",
  "Estudiar solo eso": "Study only that",
  "Volver a medir con otro simulacro": "Measure again with another mock",
  ...
  "Escribir un libro": "Write a book",
  "cuota diaria de palabras": "a daily word count",
  "Una frase que diga de qué va": "One sentence that says what it's about",
  "Escribirla en una línea": "Write it in one line",
  "Leérsela a alguien": "Read it out to someone",
  "Que la entienda sin que expliques": "Have them understand it without you explaining",
  "La escaleta: qué pasa y en qué orden": "The outline: what happens and in what order",
  "Apuntar el principio y el final": "Write down the beginning and the end",
  "Los cinco o seis momentos de en medio": "The five or six moments in between",
  "Ponerlos en orden": "Put them in order",
  "Elegir tu cuota diaria y escribirla en la pared":
    "Pick your daily count and write it on the wall",
  "1 667 palabras al día, treinta días": "1,667 words a day, thirty days",
  "La cuota antes de cualquier otra cosa del día": "The count before anything else in the day",
  "No volver atrás a arreglar": "Don't go back to fix things",
  "Anotar el número cada noche": "Write down the number every night",
  "Las primeras diez mil palabras": "The first ten thousand words",
  "Cincuenta mil palabras: el primer mes completo":
    "Fifty thousand words: the first full month",
  "La mitad del borrador": "Half the draft",
  "Terminar el primer borrador, malo o bueno": "Finish the first draft, good or bad",
  "Escribir el último capítulo aunque falten cosas en medio":
    "Write the last chapter even if things are missing in the middle",
  "Poner la palabra fin": "Write the word end",
  "Un mes sin tocarlo": "A month without touching it",
  "Leerlo entero de un tirón, sin corregir": "Read it end to end in one go, without correcting",
  "La primera corrección, de principio a fin": "The first revision, beginning to end",
  "Dárselo a leer a tres personas": "Give it to three people to read",
  "Elegir a tres que te digan la verdad": "Pick three who'll tell you the truth",
  "Darles algo concreto que mirar": "Give them something specific to look at",
  "Escuchar sin defenderte": "Listen without defending yourself",
  "La versión que sí enseñarías": "The version you'd actually show",
  "Escribir la cuota del día": "Write the day's count",
  "Leer media hora": "Read for half an hour",
  "Abrir mi negocio pequeño": "Start my small business",
  "Mi negocio": "My business",
  "validación por compromisos": "validation by commitments",
  "Escribir qué vendes y a quién, en un párrafo":
    "Write what you sell and to whom, in one paragraph",
  "Diez conversaciones sin mencionar tu idea": "Ten conversations without mentioning your idea",
  "Hacer la lista de diez": "Make the list of ten",
  "Hablar de su vida, no de tu idea": "Talk about their life, not your idea",
  "No pedir opiniones": "Don't ask for opinions",
  "Anotar lo que dijeron, no lo que interpretaste":
    "Write down what they said, not what you read into it",
  "Preguntar qué hacen hoy y qué les cuesta": "Ask what they do today and what it costs them",
  "Cómo lo resuelven hoy": "How they solve it today",
  "Cuánto tiempo o dinero les cuesta": "How much time or money it costs them",
  "Qué han intentado ya": "What they've already tried",
  "Qué pasó la última vez que les pasó": "What happened the last time it came up",
  "Conseguir el primer compromiso: tiempo, nombre o dinero":
    "Get the first commitment: time, name or money",
  "Pedir algo concreto: una reunión, una presentación, un anticipo":
    "Ask for something concrete: a meeting, an introduction, a deposit",
  "Si no sueltan nada, no es validación": "If they give up nothing, it isn't validation",
  "Apuntar quién sí": "Write down who did",
  "Poner el precio con las cuentas hechas": "Set the price with the sums done",
  "Comprar lo mínimo para empezar": "Buy the minimum to start",
  "La primera venta": "The first sale",
  "Un cliente que repite": "A customer who comes back",
  "Diez ventas": "Ten sales",
  "Saber cuánto te deja cada venta, ya descontado todo":
    "Know what each sale leaves you, once everything is deducted",
  "Cuánto te cuesta hacerlo": "What it costs you to make",
  "Cuánto vale tu tiempo": "What your time is worth",
  "Restarlo del precio": "Subtract it from the price",
  "Ver si el número sigue teniendo sentido": "See whether the number still makes sense",
  "Tres meses seguidos vendiendo": "Three months in a row selling",
  "Que cubra sus propios gastos": "Have it cover its own costs",
  "Sumar lo que gastas al mes": "Add up what you spend each month",
  "Sumar lo que entra": "Add up what comes in",
  "Ver la diferencia sin maquillarla": "Look at the difference without dressing it up",
  "Que te pague un mes de tu vida": "Have it pay for a month of your life",
  "Buscar un cliente": "Look for a customer",
  "Revisar los números": "Go over the numbers",
  "La casa": "The house",
  "3 meses": "3 months",
  "orden por categorías": "tidying by category",
  "Categoría 1: la ropa, toda junta en un sitio": "Category 1: clothes, all in one place",
  "Sacarla toda a un solo sitio, de toda la casa":
    "Bring it all to one spot, from the whole house",
  "Decidir prenda por prenda": "Decide item by item",
  "Guardar solo lo que se queda": "Put away only what stays",
  "Sacar el resto de la habitación": "Get the rest out of the room",
  "Categoría 2: los libros": "Category 2: books",
  "Categoría 3: los papeles, que casi todos se van":
    "Category 3: papers, nearly all of which go",
  "Casi todo se va": "Nearly everything goes",
  "Se quedan los que usas ahora, los de un trámite abierto y los que la ley pide":
    "You keep the ones you use now, the ones for open paperwork and the ones the law requires",
  "Lo demás no se guarda por si acaso": "The rest isn't kept just in case",
  "Categoría 4: komono, lo de la cocina y el baño":
    "Category 4: komono, the kitchen and bathroom",
  "Categoría 4: komono, lo demás": "Category 4: komono, everything else",
  "Vaciar la categoría entera sobre la mesa": "Empty the whole category onto the table",
  "No volver a meter nada por costumbre": "Don't put anything back out of habit",
  "Lo que no tiene sitio, no se queda": "What has no place doesn't stay",
  "Categoría 5: lo sentimental, que va al final":
    "Category 5: sentimental things, which come last",
  "Sacar de casa lo que decidiste soltar": "Get what you decided to let go out of the house",
  "Separar lo que se dona, lo que se vende y lo que se tira":
    "Separate what's donated, what's sold and what's thrown out",
  "Ponerle fecha a cada cosa": "Give each one a date",
  "Que salga de casa esa semana": "Have it leave the house that week",
  "Cada cosa con su sitio fijo": "Everything with a fixed place",
  "Que todo se vea de un vistazo al abrir": "See everything at a glance when you open it",
  "Nada apilado detrás de otra cosa": "Nothing stacked behind something else",
  "Que puedas devolverlo en un gesto": "So you can put it back in one motion",
  "Que un vistazo baste para saber qué hay": "So one glance tells you what's there",
  "Quince minutos al día durante un mes": "Fifteen minutes a day for a month",
  "Una revisión al mes": "One check a month",
  "Tres meses sin que se vuelva a acumular": "Three months without it piling up again",
  "Quince minutos de recoger": "Fifteen minutes of tidying",
  "Una categoría a fondo": "One category properly",
  "Mudarme de país": "Move to another country",
  "La mudanza": "The move",
  "requisitos oficiales, en orden": "official requirements, in order",
  "Elegir el país y el tipo de permiso": "Pick the country and the kind of permit",
  "La lista de requisitos, de la fuente oficial":
    "The list of requirements, from the official source",
  "Buscar la página oficial del gobierno y no un blog":
    "Find the official government page, not a blog",
  "Bajar la lista": "Download the list",
  "Guardar la fecha en que la bajaste": "Save the date you downloaded it",
  "Apuntar qué caduca y en cuánto tiempo": "Write down what expires and how soon",
  "Cuánto vale cada documento": "What each document costs",
  "Cuánto tarda en salir": "How long it takes to come through",
  "Cuánto dura antes de caducar": "How long it lasts before it expires",
  "Ponerlos en una línea de tiempo hacia atrás": "Lay them on a timeline running backwards",
  "Juntar los papeles que ya tienes": "Gather the papers you already have",
  ...
  "Calcular tres meses de gastos en el país nuevo":
    "Work out three months of expenses in the new country",
  "Ponerle fecha": "Give it a date",
  "Guardarlo aparte y no tocarlo": "Keep it separate and don't touch it",
  "Resolver el día a día en el idioma": "Handle day-to-day life in the language",
  ...
  "Los trámites de los primeros treinta días allá":
  ...
  */
  ...
  /* ---- La Jornada (en prueba, 0.7.101) ---- */
  "Jornada": "Day",
  "Prueba": "Beta",
  "En prueba: tu día en una rueda, con reloj de enfoque": "Beta: your day on a wheel, with a focus timer",
  "Jornada encendida: ya está en tu menú": "Day is on: it's now in your menu",
  "Jornada apagada": "Day is off",
  "Dormir": "Sleep",
  "Bloque libre": "Free block",
  "Talentos en curso": "Talents in progress",
  "Encargos en curso": "Assignments in progress",
  "Misión": "Mission",
  "{0} min": "{0} min",
  "{0} h {1} min": "{0} h {1} min",
  "{0} h": "{0} h",
  "Tramo {0} de {1} listo": "Session {0} of {1} done",
  "{0} min de foco. Toca descansar.": "{0} min of focus. Time for a break.",
  "Se acabó el descanso": "Break's over",
  "Sigue el tramo {0}.": "Session {0} is next.",
  "Sin atar": "Unlinked",
  "Abandonado · sin XP": "Abandoned · no XP",
  "Queda en tu registro": "Saved in your log",
  "Sin tocar ningún módulo.": "Without touching any module.",
  "{0} min de foco en «{1}»": "{0} min of focus on «{1}»",
  "La misión ya estaba cumplida hoy.": "The mission was already done today.",
  "Misión cumplida": "Mission accomplished",
  "Y su habilidad recibe {0} XP.": "And its skill gets {0} XP.",
  "Con {0} min de foco.": "With {0} min of focus.",
  "{0} min de foco apuntados": "{0} min of focus logged",
  "La misión sigue abierta.": "The mission stays open.",
  "Queda en el registro de tu Jornada.": "It stays in your Day log.",
  "Ya llegaste al tope de práctica de hoy.": "You already hit today's practice cap.",
  "+{0} XP a {1}": "+{0} XP to {1}",
  "Cuenta como práctica de hoy: no baja.": "It counts as today's practice: it won't drop.",
  "Por «{0}», que la entrena.": "Through «{0}», which trains it.",
  "Enfoque: {0}": "Focus: {0}",
  "{0} sube de nivel": "{0} levels up",
  "{0} · terminaste los {1} tramos": "{0} · you finished all {1} sessions",
  ...
  "Tramo {0} de {1}": "Session {0} of {1}",
  "Terminar por hoy": "Done for today",
  "Pausa": "Pause",
  "Seguir": "Resume",
  "Terminar": "Finish",
  "Abandonar": "Abandon",
  "Saltar el descanso": "Skip the break",
  "Saltar lo que queda": "Skip the rest",
  "Reiniciar fase": "Restart phase",
  "La fase vuelve a empezar": "The phase starts over",
  "Acabas a las {0}": "Ends at {0}",
  "Si sigues, acabas a las {0}": "If you resume, ends at {0}",
  "Guardar el tramo": "Save the session",
  "Sin atar: solo queda en tu registro.": "Unlinked: it only goes into your log.",
  "Al acabar el tramo te pregunta si la terminaste.": "When the session ends it asks whether you finished it.",
  "Cada tramo cuenta como práctica y le da XP.": "Each session counts as practice and gives it XP.",
  "Cada tramo le da XP a {0}, la habilidad que entrena.": "Each session gives XP to {0}, the skill it trains.",
  "Nada a esta hora": "Nothing at this hour",
  "Enfoque libre": "Free focus",
  "Foco · {0} de {1}": "Focus · {0} of {1}",
  "Descanso": "Break",
  "Luego, tramo {0}": "Next, session {0}",
  "Tramo listo": "Session done",
  "Toca para guardar el tramo": "Tap to save the session",
  "Ritmo": "Rhythm",
  "¿Cómo quieres ir?": "What pace do you want?",
  "Clásico": "Classic",
  "Profundo": "Deep",
  "Cuenta hacia arriba hasta que tú lo pares. El reloj se voltea solo cada 25 minutos.": "It counts up until you stop it. The hourglass flips on its own every 25 minutes.",
  "Foco": "Focus",
  "Tramos": "Sessions",
  "Seguir solo": "Keep going on its own",
  "El siguiente tramo arranca sin tocar nada": "The next session starts without you touching anything",
  "Sonido": "Sound",
  "Avisarme en otra pestaña": "Notify me in another tab",
  "Con la app abierta en segundo plano": "With the app open in the background",
  "Enfocar en": "Focus on",
  "¿En qué?": "On what?",
  "Lo que toca ahora": "What's scheduled now",
  "No hay nada a esta hora": "There's nothing at this hour",
  "Solo queda en tu registro": "It only goes into your log",
  "Bloque": "Block",
  "Nuevo bloque": "New block",
  "Empieza": "Starts",
  "Acaba": "Ends",
  "Se encima con «{0}». Muévelo o acórtalo.": "It overlaps «{0}». Move it or shorten it.",
  "Dura {0}.": "Lasts {0}.",
  "Guardar": "Save",
  "Toca otra vez para quitarlo": "Tap again to remove it",
  "Quitar de la rueda": "Remove from the wheel",
  "¿La terminaste?": "Did you finish it?",
  "Sí": "Yes",
  "Todavía no": "Not yet",
  "¿Cómo te fue?": "How did it go?",
  "Disperso": "Scattered",
  "Bien": "Good",
  "Muy enfocado": "Very focused",
  ...
  "Pomodoro": "Pomodoro",
  "En prueba: tu día en una rueda, con tramos de enfoque": "Beta: your day on a wheel, with focus sessions",
  "Pomodoro encendido: ya está en tu menú": "Pomodoro is on: it's now in your menu",
  "Pomodoro apagado": "Pomodoro is off",
  "Queda en tu registro del Pomodoro.": "It stays in your Pomodoro log.",
  "Comer": "Eat",
  "Traslado": "Commute",
  "Hora de dormir": "Bedtime",
  "Hora de comer": "Mealtime",
  "En camino": "On the way",
  "Tramo abandonado": "Session abandoned",
  "Deshacer": "Undo",
  "El tramo sigue, en pausa": "The session is back, paused",
  "Que descanses. Al despertar, toca «Buenos días».": "Rest well. When you wake up, tap «Good morning».",
  "Buenos días · dormiste {0}": "Good morning · you slept {0}",
  "En {0} min toca dormir": "Bedtime in {0} min",
  "Tu bloque de dormir empieza a las {0}.": "Your sleep block starts at {0}.",
  "dormiste {0}": "you slept {0}",
  "Buenas noches, a dormir": "Good night, off to bed",
  "Bloque de descanso: no lleva tramos.": "Rest block: no sessions here.",
  "Enfocar de todos modos": "Focus anyway",
  "Tócalo al despertar y queda apuntado cuánto dormiste.": "Tap it when you wake up and it logs how long you slept.",
  "Toca al irte a dormir y al despertar: así sabes cuánto dormiste.": "Tap when you go to sleep and when you wake up: that's how you know how long you slept.",
  "Durmiendo": "Sleeping",
  "Desde las {0}": "Since {0}",
  ...
  /* ---- El Pomodoro: informe, modo rápido y «Sin vincular» (0.7.104) ---- */
  "Mi día": "My day",
  "Solo enfocar": "Just focus",
  "Cómo usar el Pomodoro": "How to use the Pomodoro",
  "Hiperfoco": "Hyperfocus",
  "Un reloj y nada más": "A timer and nothing else",
  "Sin límite": "No limit",
  "Luego, otro tramo si quieres": "Then another session if you want",
  "{0} min de hiperfoco": "{0} min of hyperfocus",
  "{0} min de hiperfoco.": "{0} min of hyperfocus.",
  "Cuando quieras, otro tramo.": "Another session whenever you want.",
  "{0} min de hiperfoco apuntados": "{0} min of hyperfocus logged",
  "Menos de un minuto: no queda apuntado": "Less than a minute: nothing logged",
  "Enfocar": "Focus",
  ...
  "Sin vincular: solo queda en tu registro.": "Unlinked: it only goes into your log.",
  "Y su habilidad recibe {0} XP, a nombre del Pomodoro.": "And its skill gets {0} XP, credited to the Pomodoro.",
  "Tramo {0}": "Session {0}",
  "Tu foco": "Your focus",
  "Lo que de verdad le dedicaste, sin contar las pausas.": "What you actually put in, not counting pauses.",
  "De foco": "Of focus",
  "Tramos hechos": "Sessions done",
  "Terminadas con el Pomodoro": "Finished with the Pomodoro",
  "Y un tramo abandonado, que no dio XP.": "And one abandoned session, which gave no XP.",
  "Y {0} tramos abandonados, que no dieron XP.": "And {0} abandoned sessions, which gave no XP.",
  "Le dio {0} XP a tus habilidades.": "It gave {0} XP to your skills.",
  "¿Cuándo te enfocaste?": "When did you focus?",
  "Cuando hagas tu primer tramo, aquí se verá en qué días.": "Once you do your first session, you'll see which days here.",
  "Hubo foco {0} días de este periodo.": "You focused on {0} days this period.",
  "Cuando hagas tu primer tramo, aquí se llena el calendario.": "Once you do your first session, the calendar fills up here.",
  "¿Cumpliste lo que planeaste?": "Did you do what you planned?",
  "De los bloques de enfoque de tu rueda, cuántos tuvieron al menos un tramo.": "Of the focus blocks on your wheel, how many got at least one session.",
  "Cuando acomodes tu día en la rueda, aquí se verá cuánto de lo planeado tuvo foco.": "Once you lay out your day on the wheel, you'll see here how much of the plan got focus.",
  "{0} de {1} bloques con foco": "{0} of {1} blocks with focus",
  "Toca «Buenas noches» al irte a dormir y «Buenos días» al despertar, y aquí se verá cuánto duermes.": "Tap «Good night» when you go to bed and «Good morning» when you wake up, and you'll see here how much you sleep.",
  "Promedio por noche": "Average per night",
  "Noches registradas": "Nights logged",
  "¿Cuánto dormiste?": "How much did you sleep?",
  "Las noches de menos de seis horas van en coral.": "Nights under six hours are in coral.",
  "Lo que contestaste al cerrar cada tramo.": "What you answered when closing each session.",
  "1 tramo": "1 session",
  "{0} tramos": "{0} sessions",
  "Al cerrar tus tramos, aquí se verá cómo te fue.": "Once you close your sessions, you'll see here how they went.",
  "¿En qué pusiste el foco?": "What did you focus on?",
  "Las cinco cosas a las que más tiempo le diste.": "The five things you gave the most time to.",
  "Aquí saldrá a qué le dedicas más foco.": "What you focus on most will show up here.",
  "Dormiste en promedio {0} por noche, menos de seis horas. El foco de mañana sale de ahí.": "You slept {0} a night on average, under six hours. Tomorrow's focus comes from there.",
  "Dormiste en promedio {0} por noche. Con eso el foco tiene de dónde salir.": "You slept {0} a night on average. That gives your focus something to run on.",
  "Abandonaste {0} tramos. Prueba tramos más cortos: quince o veinte minutos que terminas pesan más que veinticinco que no.": "You abandoned {0} sessions. Try shorter ones: fifteen or twenty minutes you finish count for more than twenty-five you don't.",
  "Solo {0} de {1} bloques planeados tuvieron foco. Quizá la rueda pide menos bloques, no más ganas.": "Only {0} of {1} planned blocks got focus. Maybe the wheel needs fewer blocks, not more willpower.",

  /* ---- El Hiperfoco: tres maneras (0.7.105) ---- */
  "Rutina diaria": "Daily routine",
  "Travesía": "Journey",
  "Inmersión": "Deep dive",
  "Respiro": "Breather",
  "{0} / {1} min · {2} rondas": "{0} / {1} min · {2} rounds",
  "{0} min sin pausa": "{0} min nonstop",
  "{0} min de calma": "{0} min of calm",
  "Sumergirme": "Dive in",
  "Respirar": "Breathe",
  "Ronda {0} de {1} lista": "Round {0} of {1} done",
  "Descansa {0} min.": "Rest {0} min.",
  "Terminaste tus {0} rondas.": "You finished your {0} rounds.",
  "Tu respiro terminó": "Your breather is over",
  "Vuelve cuando quieras.": "Come back whenever you want.",
  "De vuelta al foco": "Back to focus",
  "Ronda {0} de {1}.": "Round {0} of {1}.",
  "Ronda {0} de {1}": "Round {0} of {1}",
  "Sin pausas": "No breaks",
  "Nada que hacer: solo respirar": "Nothing to do: just breathe",
  "Luego, ronda {0} de {1}": "Next, round {0} of {1}",
  "¿Cómo quieres llamarlo?": "What do you want to call it?",
  "Déjalo vacío para volver al nombre de siempre.": "Leave it empty to go back to the usual name.",
  ...
  "Ya desperté": "I'm awake",
  "Buenos días, ya desperté": "Good morning, I'm awake",
  "Vincular entre semana y fin de semana": "Link weekdays and weekend",
  "Vinculado: una rutina para los cinco días hábiles y otra para el fin de semana": "Linked: one routine for the five weekdays and another for the weekend",
  "Sin vincular: cada día lleva la suya, siete en total": "Not linked: each day has its own, seven in total",
  "Día de la rutina": "Routine day",
  "Lo que cambies aquí se copia a sábado y domingo.": "What you change here is copied to Saturday and Sunday.",
  "Lo que cambies aquí se copia a los cinco días hábiles.": "What you change here is copied to the five weekdays.",
  "Estás viendo tu {0}. Los tramos se inician en el día de hoy.": "You're looking at your {0}. Stretches start on today.",
  "Hoy, {0}.": "Today, {0}.",
  "Estás acomodando tu {0}.": "You're arranging your {0}.",
  "Para iniciar un tramo, vuelve al día de hoy.": "To start a stretch, go back to today.",
  "Vincular": "Link",
  "¿Con cuál rutina te quedas?": "Which routine do you keep?",
  "Vincular deja una rutina para los cinco días hábiles y otra para el fin de semana. Los días que no elijas se sobrescriben, y desvincular después no lo deshace.": "Linking leaves one routine for the five weekdays and another for the weekend. The days you don't pick get overwritten, and unlinking later doesn't undo it.",
  "Entre semana": "Weekdays",
  "Fin de semana": "Weekend",
  "Vincular y sobrescribir": "Link and overwrite",
  "Desvinculado: cada día se queda como está": "Unlinked: each day stays as it is",
  "Vinculado: dos rutinas, entre semana y fin de semana": "Linked: two routines, weekdays and weekend",
  "Domingo": "Sunday",
  "Lunes": "Monday",
  "Martes": "Tuesday",
  "Miércoles": "Wednesday",
  ...
  "bloques": "blocks",
  "sin foco": "no focus",
  "{0} de foco": "{0} of focus",
  "1 bloque de foco": "1 focus block",
  "{0} bloques de foco": "{0} focus blocks",
  "Sin bloques de foco": "No focus blocks",
  "Del plan": "Of the plan",
  "Sueño por noche": "Sleep per night",
  "Foco · {0} días": "Focus · {0} days",
  "Minutos de foco {0}": "Focus minutes {0}",
  "Tramos {0}": "Stretches {0}",
  "Del plan cumplido {0}": "Of the plan met {0}",
  "Sueño por noche {0}": "Sleep per night {0}",
  "de foco hoy": "of focus today",
  "Ahora toca": "Now it's",
  "Ahora, descanso": "Now, a break",
  "Lo siguiente": "Up next",
  "{0} · {1}": "{0} · {1}",
  "Acomoda un bloque o enfoca sin vincular": "Add a block or focus without linking",
  "Tu día, en una rueda": "Your day, on a wheel",
  ...
  "Secreto": "Secret",
  "Arcade no sale en ningún menú: está aquí porque lo encontraste. Va encima de tu ambiente: cambia la letra, las esquinas, el movimiento y los sonidos, y los colores siguen siendo los tuyos.": "Arcade isn't in any menu: it's here because you found it. It sits on top of your theme: it changes the lettering, the corners, the motion and the sounds, and the colors stay yours.",
  "Llevas un mundo puesto: al ponerte Arcade, vuelves a tu ambiente.": "You're wearing a world: putting on Arcade takes you back to your theme.",
  "Lo llevas puesto": "You're wearing it",
  "La cuadrícula manda": "The grid rules",
  "Quitar": "Remove",
  "Ponerlo": "Put it on",
  "Sonidos de 8 bits": "8-bit sounds",
  "Al cumplir una misión, al subir de nivel y al terminar un tramo del Pomodoro.": "When you complete a mission, level up or finish a Pomodoro block.",
  "Encontraste un mundo que no sale en ningún menú. Ya es tuyo.": "You found a world that isn't in any menu. It's yours now.",
  "Ya es tuyo, y lo llevas puesto.": "It's yours, and you're wearing it.",
  "Ya era tuyo. Se vuelve a poner.": "It was already yours. Putting it back on.",
  "Mundo Arcade": "Arcade world",
  "MUNDO ARCADE": "ARCADE WORLD",
  "Se cambia cuando quieras en Ajustes → Mi apariencia.": "Change it anytime in Settings → My appearance.",
  "Arriba, arriba, abajo, abajo… lo demás lo sabe quien creció con un control en las manos.": "Up, up, down, down… anyone who grew up with a controller in their hands knows the rest.",
  "Un píxel": "A pixel",
  "Arriba": "Up",
  "Abajo": "Down",
  "Izquierda": "Left",
