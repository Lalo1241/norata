...
-- ============================================================
--
-- Se hizo el 27 ago 2026, al separar la cuenta de trabajo (correo-admin@ejemplo.com)
-- de la personal (correo-personal@ejemplo.com). Queda escrito porque el orden
...
--
--        delete from public.administradores where user_id = (
--          select id from auth.users where email = 'correo-personal@ejemplo.com');
--
