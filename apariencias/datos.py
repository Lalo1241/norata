...
AMBIENTES = [
 ...
 dict(id="musgo", nombre="Musgo", grado=1, abre="Nivel 2",
  ...
  noche={"--bg":"#0d1611","--bg2":"#131f18","--card":"#18241c","--card2":"#1e2c22",
   "--line":"#2a3a2e","--carril":"#2a3a2e","--text":"#e8f1e9","--muted":"#87998c","--faint":"#5c6b60"},
  dia={"--bg":"#e8ebe6","--bg2":"#eef1ec","--card":"#f4f7f3","--card2":"#fcfdfb",
   "--line":"#c2c9c0","--carril":"#ccd4cb","--text":"#16211a","--muted":"#57655b","--faint":"#78877c"}),

 dict(id="adobe", nombre="Adobe", grado=1, abre="Nivel 8",
  ...
  noche={"--bg":"#1b1512","--bg2":"#241c18","--card":"#30231e","--card2":"#3a2b25",
   "--line":"#4d3931","--carril":"#4d3931","--text":"#f4ebe4","--muted":"#ab958a","--faint":"#7c6a60"},
  dia={"--bg":"#e3d4ca","--bg2":"#ece0d8","--card":"#f4ebe4","--card2":"#faf5f0",
   "--line":"#c2ad9f","--carril":"#d0bdaf","--text":"#241a14","--muted":"#6b5a50","--faint":"#8c7a70"}),

 dict(id="duna", nombre="Duna", grado=1, abre="Nivel 10",
 ...
 dict(id="escarcha", nombre="Escarcha", grado=2, abre="Nivel 12 · con Pro",
  ...
  noche={"--bg":"#0c141c","--bg2":"#121b24","--card":"#18222d","--card2":"#1e2933",
   "--line":"#27333f","--carril":"#27333f","--text":"#e7f0f5","--muted":"#8496a3","--faint":"#5a6b78",
   "--mint":"#8ecdf5","--mint-macizo":"#8ecdf5","--aro-alto":"#8ecdf5"},
  dia={"--mint":"#0f688f","--mint-macizo":"#3ab0e0","--aro-alto":"#1a8cbe"}),

 dict(id="marea", nombre="Marea", grado=2, abre="Nivel 22 · con Pro",
  ...
  noche={"--bg":"#04161c","--bg2":"#072028","--card":"#0d2c37","--card2":"#123642",
...
RANGOS = [
 dict(nivel=1,  nombre="Semilla", trazo='<path d="M12 3.4c4 3.4 6.3 7 6.3 10.6 0 3.8-2.8 6.8-6.3 6.8s-6.3-3-6.3-6.8c0-3.6 2.3-7.2 6.3-10.6z"/><path d="M12 9.4v8.4"/>', cuando="El primer día", que="Una gota cerrada. Cae la semilla y aparece la barra: antes del primer nivel no hay nada que enseñar."),
 dict(nivel=4,  nombre="Brote", trazo='<path d="M12 20.6v-8"/><path d="M12 15.4c-3.6 0-6-2.3-6-5.8 3.9-.4 6 2.2 6 5.8z"/><path d="M12 13.2c0-3.7 2.4-6.2 6.2-5.9 0 3.6-2.5 5.9-6.2 5.9z"/><path d="M6 20.6h12"/>',   cuando="Tres días de uso normal", que="La misma planta después: un tallo con dos hojas. Es el cambio de rango que menos se nota, y es a propósito el más temprano."),
 dict(nivel=10, nombre="Refugio", trazo='<path d="M12 4.6L2.8 19.6h18.4z"/><path d="M12 4.6L8.4 19.6 12 15.2l3.6 4.4z"/>', cuando="Mes y medio", que="Se acampa. El último peldaño que se da solo por usarla."),
 dict(nivel=18, nombre="Cima", trazo='<path d="M3 19.2l7-11.2 4 5.7 2.2-2.9 5.8 8.4z"/><path d="M10 8V3.4"/><path d="M10 3.9l4.4 1.5L10 7z"/>',    cuando="Seis meses", que="Se llega arriba. De las tres montañas que había sobrevive una, la que dice más."),
 dict(nivel=28, nombre="Norte", trazo='<path d="M12 2.6l2.5 6.9 6.9 2.5-6.9 2.5-2.5 6.9-2.5-6.9L2.6 12l6.9-2.5z"/>',   cuando="Año y tres meses", que="Arriba ya solo queda la estrella que orienta. El último: quien llega, se queda ahí."),
]
...
ESCALERA = [
 ...
 (2,  "Musgo", "ambiente", ""),
 (3,  "Destello propio al cumplir una misión", "celebracion", ""),
 (4,  "Rango Brote", "rango", ""),
 (6,  "Escena nueva de racha", "celebracion", ""),
 (8,  "Adobe", "ambiente", ""),
 (10, "Rango Refugio, Duna y escena grande", "rango+ambiente+celebracion", "El último ambiente que se da solo por usarla"),
 (12, "Escarcha", "ambiente", "Pro"),
 (15, "Celebración de pantalla completa", "celebracion", "Pro"),
 (18, "Rango Cima", "rango", ""),
 (22, "Marea", "ambiente", "Pro"),
 (28, "Rango Norte", "rango", ""),
]
